...
const ShowroomPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-10 mt-2 mb-10">
      {/* HEADER SECTION */}
      <div className="bg-[#151517] text-white py-12 mb-3 rounded-md relative z-0">
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <p className="text-gray-400 max-w-2xl mx-auto">
            ...
            cửa hàng trên toàn quốc. Đội ngũ tư vấn chuyên nghiệp luôn sẵn sàng
            hỗ trợ bạn.
          </p>
        </div>
      </div>
